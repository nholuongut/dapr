...
## Project Maintainers
[Project maintainers](https://github.com/nholuongut/dapr/blob/master/MAINTAINERS.md) are responsible for activities around maintaining and updating Dapr. Final decisions on the project reside with the project maintainers.
...
A maintainer may step down by submitting an [issue](https://github.com/nholuongut/dapr/issues/new) stating their intent.
