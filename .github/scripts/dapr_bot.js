...
[Dapr Bot](https://github.com/nholuongut/dapr/blob/master/.github/workflows/dapr-bot.yml) because a \"docs-needed\" label \
was added to nholuongut/dapr#${issueNumber}. \n\n\
TODO: Add more details as per [this template](.github/ISSUE_TEMPLATE/new-content-needed.md).`

const sdkIssueBodyTpl = (
    issueNumber
) => `This issue was automatically created by \
[Dapr Bot](https://github.com/nholuongut/dapr/blob/master/.github/workflows/dapr-bot.yml) because a \"sdk-needed\" label \
was added to nholuongut/dapr#${issueNumber}. \n\n\
...
async function handleIssueLabeled({ github, context }) {
    ...
    if (label == 'docs-needed') {
        ...
        await github.rest.issues.create({
            owner: 'dapr',
            repo: 'docs',
            title: `New content needed for nholuongut/dapr#${issueNumber}`,
        ...
        for (const sdk of SDKs) {
            await github.rest.issues.create({
                owner: 'dapr',
                repo: sdk,
                title: `Add support for nholuongut/dapr#${issueNumber}`,
