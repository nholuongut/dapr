...
* Set up [Dapr development environment](https://github.com/nholuongut/dapr/blob/master/docs/development/setup-dapr-development-env.md)
...
```
`<app-name>` can be found at [PERF_TEST_APPS](https://github.com/nholuongut/dapr/blob/6def7d1b9ffe896b7b06d05128b9cd605d39f939/tests/dapr_tests.mk#L61C1-L61C15)
...
make test-perf-all
```
Then it will run the tests defined in `DAPR_PERF_TEST`. `<app-name>` can be found at [PERF_TESTS](https://github.com/nholuongut/dapr/blob/6def7d1b9ffe896b7b06d05128b9cd605d39f939/tests/dapr_tests.mk#L70)
