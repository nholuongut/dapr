...
import (
	...
	"github.com/nholuongut/dapr/tests/e2e/utils"
...
func TestMain(m *testing.M) {
	...
	if utils.TestTargetOS() != "windows" {
		...
		testApp.AppEnv = map[string]string{
			"DAPR_GRPC_SOCKET_ADDR": "/var/nholuongut/dapr-" + appName + "-grpc.socket",
			"DAPR_HTTP_SOCKET_ADDR": "/var/nholuongut/dapr-" + appName + "-http.socket",
		}
	}
