...
This project has adopted the [Contributor Covenant Code of Conduct](https://github.com/nholuongut/dapr/blob/master/CODE-OF-CONDUCT.md).
...
1. Check for existing issues
    - Before you create a new issue, please do a search in [open issues](https://github.com/nholuongut/dapr/issues) to see if the issue or feature request has already been filed.
...
1. For proposals
    - Many changes to the Dapr runtime may require changes to the API. In that case, the best place to discuss the potential feature is the main [Dapr repo](https://github.com/nholuongut/dapr).
