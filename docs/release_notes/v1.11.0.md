...
- The Dapr dashboard is no longer installed by default with the Dapr control plane when installing via Helm. To install the dashboard, use the new `dapr-dashboard` chart: 
  ...
  helm install dapr nholuongut/dapr-dashboard --namespace dapr-system
  ```
...
- Metrics for [actor reminders and timers](https://github.com/nholuongut/dapr/blob/master/docs/development/dapr-metrics.md#actors) are now reported
- Metrics for [resiliency policies](https://github.com/nholuongut/dapr/blob/master/docs/development/dapr-metrics.md#resiliency) are now reported
...
- App Health Checks is now stable, changing the default HTTP healthcheck path to `/healthz` [6217](https://github.com/nholuongut/dapr/issues/6217)
...
- **ADDED** Multiple build variations of Dapr sidecar: `stablecomponents` and `allcomponents` [3168](https://github.com/nholuongut/dapr/issues/3168) [6465](https://github.com/nholuongut/dapr/pull/6465)
- **ADDED** Kubernetes labels `dapr.io/sidecar-injected` and `dapr.io/app-id` when Dapr sidecar is injected [4366](https://github.com/nholuongut/dapr/issues/4366) [6275](https://github.com/nholuongut/dapr/pull/6275)
- **ADDED** Extend Service invocation to non-Dapr endpoints [4549](https://github.com/nholuongut/dapr/issues/4549)
- **UPDATED** Dapr Dashboard has been moved from `dapr` Helm chart to a new `dapr-dashboard` chart [4724](https://github.com/nholuongut/dapr/issues/4724)
- **FIXED** Distinguish between retrialable and non-retriable errors when publishing messages with pubsub [5136](https://github.com/nholuongut/dapr/issues/5136)
- **UPDATED** Make Configuration API stable [5522](https://github.com/nholuongut/dapr/issues/5522)
- **FIXED** Dapr Operator uses lots of memory when there are lots of pods that aren't Dapr-enabled [5693](https://github.com/nholuongut/dapr/issues/5693)
- **ADDED** Accept traceparent for incoming CloudEvent [5757](https://github.com/nholuongut/dapr/issues/5757)
- **ADDED** Ingress template for the dashboard helm chart [5778](https://github.com/nholuongut/dapr/issues/5778)
- **UPDATED** Use ERR_OUTBOUND_HEALTH_NOT_READY for Dapr's outbound health error [5813](https://github.com/nholuongut/dapr/issues/5813)
- **ADDED** Option to Operator to disable the reconciler for Services [5896](https://github.com/nholuongut/dapr/pull/5896)
- **ADDED** Dynamic allowed service accounts watcher for injector [5898](https://github.com/nholuongut/dapr/pull/5898)
- **ADDED** Dynamic watch for serviceaccount UIDs so injector can inject sidecar created by a synced serviceaccount from a virtual cluster [5906](https://github.com/nholuongut/dapr/issues/5906)
- **ADDED** Support for multiple `--resources-path` flags on daprd [5909](https://github.com/nholuongut/dapr/pull/5909)
- **ADDED** When the port for the internal gRPC server is unset, return a "stable" value for better local developer experience [5914](https://github.com/nholuongut/dapr/pull/5914)
- **ADDED** Support for `seccompProfile` in Dapr sidecar via injector [5916](https://github.com/nholuongut/dapr/issues/5916)
- **ADDED** Option to skip installing the Dapr Sidecar Injector with Helm charts [5926](https://github.com/nholuongut/dapr/pull/5926)
- **FIXED** Sentry to preserve original secret metadata [5930](https://github.com/nholuongut/dapr/pull/5930)
- **ADDED** Pluggable components injector [5935](https://github.com/nholuongut/dapr/pull/5935)
- **UPDATED** Granularity on resiliency metrics [5939](https://github.com/nholuongut/dapr/issues/5939)
- **FIXED** Reduced memory consumption in Dapr Operator cache [5944](https://github.com/nholuongut/dapr/pull/5944)
- **FIXED** Allow trace header propagation without trace exporting [5967](https://github.com/nholuongut/dapr/pull/5967)
- **ADDED** API denylist to Dapr config, complementing API allowlist [5977](https://github.com/nholuongut/dapr/pull/5977)
- **ADDED** Publishing Docker images based on Windows 2022 [5999](https://github.com/nholuongut/dapr/pull/5999)
- **ADDED** Support for multiple workflow apps in a single cluster [6013](https://github.com/nholuongut/dapr/issues/6013)
- **FIXED** Create/delete reminder throwing "possible etag mismatch" after enabling resiliency [6018](https://github.com/nholuongut/dapr/issues/6018)
- **FIXED** Dapr returns 200 response instead of 302 for application redirect (version 1.10.2) [6028](https://github.com/nholuongut/dapr/issues/6028)
- **ADDED** Support Min TLS Version via Configuration [6031](https://github.com/nholuongut/dapr/issues/6031)
- **ADDED** Metrics for Actor reminder and timer [6032](https://github.com/nholuongut/dapr/issues/6032)
- **ADDED** Support for Argo Rollouts Controller  [6034](https://github.com/nholuongut/dapr/issues/6034)
- **FIXED** Panic when subscriber listen message in Redis [6036](https://github.com/nholuongut/dapr/issues/6036)
- **ADDED** New workflow APIs:
  - Pause and Resume [6042](https://github.com/nholuongut/dapr/issues/6042)
  - Purge [6043](https://github.com/nholuongut/dapr/issues/6043)
  - Support for Raise Event [6045](https://github.com/nholuongut/dapr/issues/6045)
- **UPDATED** Enforce minimum TLS version 1.2 for communication between internal Dapr services and sidecars [6069](https://github.com/nholuongut/dapr/pull/6069) [6077](https://github.com/nholuongut/dapr/pull/6077) [6094](https://github.com/nholuongut/dapr/pull/6094)
- **UPDATED** Enforce minimum TLS version to 1.2 for HTTP and gRPC app channels [6078](https://github.com/nholuongut/dapr/pull/6078)
- **FIXED** Bulk pubsub subscriber panics when tracing is disabled [6099](https://github.com/nholuongut/dapr/issues/6099)
- **FIXED** Service invocation not forwarding multiple headers with same name from response [6104](https://github.com/nholuongut/dapr/issues/6104)
- **ADDED** Ability to configure TTL in Actor State Store operations as a preview feature [6125](https://github.com/nholuongut/dapr/pull/6125) [6400](https://github.com/nholuongut/dapr/pull/6400)
- **FIXED** Alicloud tablestore is not registered in daprd [6138](https://github.com/nholuongut/dapr/issues/6138)
- **FIXED**: Health checks do not work when using HTTPS for app channel [6141](https://github.com/nholuongut/dapr/issues/6141)
- **FIXED** Workflows: actor ID should not use the `#` character (Workflows not working with Cosmos DB) [6156](https://github.com/nholuongut/dapr/issues/6156) [6294](https://github.com/nholuongut/dapr/pull/6294)
- **FIXED** Fixed: deleting a reminder should be a no-op when the reminder doesn't exist [6161](https://github.com/nholuongut/dapr/issues/6161) [6387](https://github.com/nholuongut/dapr/pull/6387)
- **ADDED** Option to disable Dapr Placement service [6173](https://github.com/nholuongut/dapr/issues/6173)
- **ADDED** Allow setting OTEL endpoint with the `OTEL_EXPORTER_OTLP_ENDPOINT` env var [6176](https://github.com/nholuongut/dapr/issues/6176)
- **ADDED** Allow overriding app channel address [6177](https://github.com/nholuongut/dapr/issues/6177)
- **ADDED** High-level crypto APIs for gRPC and HTTP [6197](https://github.com/nholuongut/dapr/pull/6197)
- **ADDED** `https` and `h2c` to `app-protocol` for better HTTP/2 support, and deprecate `app-ssl` [6205](https://github.com/nholuongut/dapr/issues/6205)
- **ADDED** Case-insensitive parsing of metadata properties `actorStateStore` and `keyPrefix` [6206](https://github.com/nholuongut/dapr/pull/6206)
- **ADDED** Azure Key Vault component for Crypto building block [6215](https://github.com/nholuongut/dapr/pull/6215)
- **UPDATED** App Health Checks are stable (and change the default HTTP healthcheck path to `/healthz`) [6217](https://github.com/nholuongut/dapr/issues/6217)
- **FIXED** Panic in bulk publish while unmarshalling incorrect cloudevent [6234](https://github.com/nholuongut/dapr/pull/6234)
- **FIXED** HTTP Channel: Add "Content-Type" header only if not empty [6236](https://github.com/nholuongut/dapr/pull/6236)
- **FIXED** Unsubscribe config api: response with incorrect subscriptionID [6272](https://github.com/nholuongut/dapr/pull/6272)
- **FIXED** Connection leak problem of app callback gRPC client [6274](https://github.com/nholuongut/dapr/pull/6274)
- **FIXED** Implement nil-check for CEL program in matchRoutingRule [6280](https://github.com/nholuongut/dapr/pull/6280)
- **ADDED** App channel address is now configurable [6281](https://github.com/nholuongut/dapr/pull/6281)
- **ADDED** `dapr_http_server_response_count` metric [6312](https://github.com/nholuongut/dapr/pull/6312)
- **FIXED** Panic while decrypting empty value from state stores [6321](https://github.com/nholuongut/dapr/pull/6321)
- **FIXED** State store: make BulkSet/BulkDelete not transactional in all state stores [6342](https://github.com/nholuongut/dapr/pull/6342)
- **ADDED** `dapr-http-max-request-size` now applies to gRPC proxying too [6349](https://github.com/nholuongut/dapr/issues/6349) [6353](https://github.com/nholuongut/dapr/pull/6353)
- **ADDED** `reinvocationPolicy: IfNeeded` to Dapr Sidecar injector [6350](https://github.com/nholuongut/dapr/pull/6350)
- **FIXED** Bulk pubsub subscriber panics when tracing is disabled [6360](https://github.com/nholuongut/dapr/pull/6360)
- **ADDED** Namespace to Helm chart resources [6375](https://github.com/nholuongut/dapr/issues/6375)
- **FIXED** RBAC permissions for operator-admin [6408](https://github.com/nholuongut/dapr/pull/6408)
- **FIXED** Bulk subscription - sidecar crashes after first batch is delivered [6414](https://github.com/nholuongut/dapr/issues/6414)
- **FIXED** Decoding slash in url [6418](https://github.com/nholuongut/dapr/issues/6418)
- **FIXED** Bulk subscribe response when app replies back with some incorrect message [6420](https://github.com/nholuongut/dapr/pull/6420)
...
helm upgrade dapr nholuongut/dapr --version 1.11 --namespace=dapr-system --wait
```
...
helm install dapr nholuongut/dapr --version 1.11 --namespace dapr-system --wait
```
...
- When communicating with apps using HTTPS or gRPC with TLS, Dapr now enforces the use of TLS 1.2 or higher. This behavior can be disabled temporarily using a Configuration option. [6078](https://github.com/nholuongut/dapr/pull/6078) [6031](https://github.com/nholuongut/dapr/issues/6031)
- The default path for HTTP app health checks has been changed to `/healthz`. The old path `/health` can still be used if configured explicitly. [6225](https://github.com/nholuongut/dapr/pull/6225)
- Dapr's Helm chart does not include the Dapr Dashboard anymore [4724](https://github.com/nholuongut/dapr/issues/4724)
- Workflows:
  - Added support for multiple workflow apps in a single cluster [6013](https://github.com/nholuongut/dapr/issues/6013)
  - Breaking changes to workflow management API [6218](https://github.com/nholuongut/dapr/pull/6218)
...
- The CLI flag `--app-ssl` (in both the Dapr CLI and daprd) has been deprecated in favor of using `--app-protocol` with values `https` or `grpcs`. [daprd:6158](https://github.com/nholuongut/dapr/issues/6158) [cli:1267](https://github.com/dapr/cli/issues/1267)
- The Windows Server 1809 images have been deprecated in favor of Windows Server 2022 images [dapr:5999](https://github.com/nholuongut/dapr/pull/5999)
