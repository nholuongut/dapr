...
- **RESOLVED** Migrate Dockerfile used to build Dapr to static, nonroot runtime image [1551](https://github.com/nholuongut/dapr/issues/1551)

- **RESOLVED** Enable sidecar to app authentication [1781](https://github.com/nholuongut/dapr/issues/1781)

- **ADDED** Support for message expiration in PubSub. [2216](https://github.com/nholuongut/dapr/issues/2216)

- **RESOLVED** Make required the version field on Component YAML [2260](https://github.com/nholuongut/dapr/issues/2260)

- **FIXED** Empty etags treated as empty etags. [2320](https://github.com/nholuongut/dapr/issues/2320)

- **Change** response handling for cross-protocol invocation. [2342](https://github.com/nholuongut/dapr/issues/2342)

- **RESOLVED** v1.0 Milestone 3 Plan [2346](https://github.com/nholuongut/dapr/issues/2346)

- **RESOLVED** Error: app not subscribed to binding  [2468](https://github.com/nholuongut/dapr/issues/2468)

- **RESOLVED** How to configure oauth middleware in dapr1.0-rc1 and running? [2474](https://github.com/nholuongut/dapr/issues/2474)

- **GENERATED** _pb.go and _grpc.pb.go separately using newer gRPC protoc for Go. [2481](https://github.com/nholuongut/dapr/issues/2481)

- **RESOLVED** The invocation chain is break when using service invoke [2504](https://github.com/nholuongut/dapr/issues/2504)

- **RESOLVED** Access control configuration invalid w/o at least 1 policy  [2526](https://github.com/nholuongut/dapr/issues/2526)

- **RESOLVED** Add Metadata gRPC API [2527](https://github.com/nholuongut/dapr/issues/2527)

- **RESOLVED** Consistency of API names surfaced by each SDK [2535](https://github.com/nholuongut/dapr/issues/2535)

- **FIXED** Docker image to be distroless and nonroot. [2536](https://github.com/nholuongut/dapr/issues/2536)

- **FIXED** Error message for unknown state stores being HTTP escaped. [2551](https://github.com/nholuongut/dapr/issues/2551)

- **RESOLVED** Remove redundant cancelfunc calls [2598](https://github.com/nholuongut/dapr/pull/2598)

- **RESOLVED** GetBulkSecrets fails when access limits are set in config [2600](https://github.com/nholuongut/dapr/issues/2600)

- **FIXED** The middleware.http.uppercase middleware comes pre-registered in Standalone mode. [2602](https://github.com/nholuongut/dapr/issues/2602)

- **RESOLVED** Make missing app-id annotation have a clearer log message [2603](https://github.com/nholuongut/dapr/issues/2603)

- **FIXED** CLI and Helm chart no longer default to amd64 architecture for Kubernetes installs. This allows deployments to arm64 Kubernetes clusters to succeed with the default configuration. [2605](https://github.com/nholuongut/dapr/issues/2605)

- **RESOLVED** Add missing metadata in getBulkState() response [2608](https://github.com/nholuongut/dapr/pull/2608)

- **RESOLVED** Update setup-dapr-development-env.md [2614](https://github.com/nholuongut/dapr/pull/2614)

- **RESOLVED** Return HTTP 409 Conflict when ETag doesn't match [2619](https://github.com/nholuongut/dapr/issues/2619)

- **RESOLVED** RBAC issue on OpenShift when installing with Helm [2620](https://github.com/nholuongut/dapr/issues/2620)

- **RESOLVED** fix(fsm): Apply return type must be bool type, or  daprd runtime maybe panic [2626](https://github.com/nholuongut/dapr/pull/2626)

- **RESOLVED** Add Known Types repeated twice [2627](https://github.com/nholuongut/dapr/issues/2627)

- **RESOLVED** Secret API "bulk" http endpoint does not work  [2649](https://github.com/nholuongut/dapr/issues/2649)

- **RESOLVED** Update Bulk Secrets API to return map[string]map[string]string [2652](https://github.com/nholuongut/dapr/issues/2652)

- **RESOLVED** Update setup-dapr-development-env.md [2664](https://github.com/nholuongut/dapr/pull/2664)

- **RESOLVED** fix(actors): timer ticker bug [2670](https://github.com/nholuongut/dapr/pull/2670)

- **RESOLVED** Helm chart tlc [2692](https://github.com/nholuongut/dapr/pull/2692)

- **FIXED** Support multiple path segments in access control policy [2725](https://github.com/nholuongut/dapr/issues/2725)

### Dapr CLI

- **RESOLVED** Dapr Uninstall Fails with Dapr: cannot get the manifest file: https://api.github.com/repos/nholuongut/dapr/releases - 403 rate limit exceeded [415](https://github.com/dapr/cli/issues/415)
...
helm upgrade dapr nholuongut/dapr --version 1.0.0-rc.3 --namespace=dapr-system --wait
```
...
helm install dapr nholuongut/dapr --version 1.0.0-rc.3 --namespace dapr-system --wait
```
...
- **FIXED** Empty etag treated as no etag. [2320](https://github.com/nholuongut/dapr/issues/2320)

- **CHANGED** response handling for cross-protocol invocation. [2342](https://github.com/nholuongut/dapr/issues/2342)
