...
### Dapr Runtime
- **RESOLVED** Allow Reentrancy for Actors [21](https://github.com/nholuongut/dapr/issues/21)
- **RESOLVED** Propagate context to PubSub handler call [1721](https://github.com/nholuongut/dapr/issues/1721)
- **RESOLVED** Add context to PubSub handler  [1749](https://github.com/nholuongut/dapr/pull/1749)
- **RESOLVED** Enhance pub/sub cloud event handling to support existing messaging infrastructure [2308](https://github.com/nholuongut/dapr/issues/2308)
- **RESOLVED** Create a dapr/kit repo to contain common packages [2820](https://github.com/nholuongut/dapr/issues/2820)
- **RESOLVED** Dapr Serialization Error with Dapr CLI Publish [2925](https://github.com/nholuongut/dapr/issues/2925)
- **RESOLVED** Refactoring codes of getting app configuration from user application [2927](https://github.com/nholuongut/dapr/pull/2927)
- **RESOLVED** Running a local gRPC with TLS service fails [2963](https://github.com/nholuongut/dapr/issues/2963)
- **RESOLVED** Default components of Self-hosted mode miss the required version field [2964](https://github.com/nholuongut/dapr/issues/2964)
- **RESOLVED** Allow concurrent reconciliation of Kubernetes resources [2993](https://github.com/nholuongut/dapr/issues/2993)
- **RESOLVED** Increase verbosity for actor errors. [3001](https://github.com/nholuongut/dapr/pull/3001)
- **ADDED** audit log to sidecar injector [3009](https://github.com/nholuongut/dapr/issues/3009)
- **ADDED** Opt-in for preview features [3048](https://github.com/nholuongut/dapr/issues/3048)
- **RESOLVED** optimize: directly use default metrics register [3053](https://github.com/nholuongut/dapr/pull/3053)
- **RESOLVED** Allow choosing which APIs are available on a sidecar [3054](https://github.com/nholuongut/dapr/issues/3054)
- **RESOLVED** Dapr sidecar failed to start: certificate has expired or is not yet valid [3058](https://github.com/nholuongut/dapr/issues/3058)
- **FIXED** Bug in runtime. [3063](https://github.com/nholuongut/dapr/issues/3063)
- **ADDED** Reentrancy bypass for actor locks [3078](https://github.com/nholuongut/dapr/issues/3078)
- **RESOLVED** operator exited with status 1 but no error log output [3082](https://github.com/nholuongut/dapr/issues/3082)
- **RESOLVED** Enable Dapr sidecars to pick up newly added components without restart [3085](https://github.com/nholuongut/dapr/issues/3085)
- **RESOLVED** Automatically merges and updates PRs. [3105](https://github.com/nholuongut/dapr/pull/3105)
- **ADDED**  nodeselector option in helm chart [3113](https://github.com/nholuongut/dapr/issues/3113)
- **RESOLVED** issue: use normalizeOperation necessity [3142](https://github.com/nholuongut/dapr/issues/3142)
- **RESOLVED** gracefully stop runtime when exited with log.Fatalf [3159](https://github.com/nholuongut/dapr/issues/3159)
- **RESOLVED** service that owner referencing with a deployment will be removed [3181](https://github.com/nholuongut/dapr/issues/3181)
### Dapr CLI
...
### Kit
- **MOVED** logger package from `nholuongut/dapr` to `dapr/kit` [1](https://github.com/dapr/kit/pull/1)
### Homebrew-tap
...
helm upgrade dapr nholuongut/dapr --version 1.2.0 --namespace=dapr-system --wait
```
...
helm install dapr nholuongut/dapr --version 1.2.0 --namespace dapr-system --wait
```
