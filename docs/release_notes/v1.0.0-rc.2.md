...
- **RESOLVED** Enable perf test UI and alerts [1790](https://github.com/nholuongut/dapr/issues/1790)

- **RESOLVED** Make Dapr logging less actor verbose [1966](https://github.com/nholuongut/dapr/issues/1966)

- **RESOLVED** Actor Reminder not persisting [2049](https://github.com/nholuongut/dapr/issues/2049)

- **FIXED** Use of Content-Type header for wrapping pubsub payload into CloudEvent [2080](https://github.com/nholuongut/dapr/issues/2080)

- **RESOLVED** Get all secrets from secrets API [2168](https://github.com/nholuongut/dapr/issues/2168)

- **FIXED** Pubsub API will now return 403 for forbidden pubsub topics. [2323](https://github.com/nholuongut/dapr/issues/2323)

- **ADDED** timeout setting for components [2352](https://github.com/nholuongut/dapr/issues/2352)

- **RESOLVED** Review and improve bulk operations of state for a  unified user experience [2368](https://github.com/nholuongut/dapr/issues/2368)

- **RESOLVED** Pass pubsub subscription metadata to pubsub component [2379](https://github.com/nholuongut/dapr/issues/2379)

- **RESOLVED** Dapr health endpoint is incorrectly reporting healthy if bindings have failed to initialize [2437](https://github.com/nholuongut/dapr/issues/2437)

- **FIXED** Changed ImagePullPolicy for Dapr sidecar Docker image from `Allways` to `IfNotPresent` [2444](https://github.com/nholuongut/dapr/issues/2444)

- **RESOLVED** dapr sidecar is crash-looping, but the logs don't indicate that anything's wrong [2449](https://github.com/nholuongut/dapr/issues/2449)

- **RESOLVED** Add components to metadata endpoint [2462](https://github.com/nholuongut/dapr/issues/2462)

- **ADDED** Reminder and State APIs for Actors in GRPC [2466](https://github.com/nholuongut/dapr/issues/2466)

- **ENABLED** DynamoDB as a supported statestore driver [2469](https://github.com/nholuongut/dapr/issues/2469)

- **ADDED** Support for imagePullSecret Secret on Helm Chart [2475](https://github.com/nholuongut/dapr/issues/2475)

- **RESOLVED** Head method not allowed by Dapr [2490](https://github.com/nholuongut/dapr/issues/2490)

- **RESOLVED** PublishRequest and SubscriberRequest need metadata  [2495](https://github.com/nholuongut/dapr/issues/2495)

- **RESOLVED** Review Grafana dashboard and fix the inconsistency [2505](https://github.com/nholuongut/dapr/issues/2505)

- **MOVED** Zipkin trace configuration from Zipkin exporter into Dapr core [2521](https://github.com/nholuongut/dapr/issues/2521)

- **RESOLVED** Move Zipkin exporter code into Dapr core [2522](https://github.com/nholuongut/dapr/issues/2522)

- **FIXED** Grpc context leak on failed connection. [2533](https://github.com/nholuongut/dapr/issues/2533)

- **ADDED** configuration for webhook failure policy in sidecar injector helm chart [2549](https://github.com/nholuongut/dapr/issues/2549)

- **FIXED** can not invoke service http route '/' [2571](https://github.com/nholuongut/dapr/issues/2571)

- **FIXED** missing traceparent for http app channel call [2588](https://github.com/nholuongut/dapr/issues/2588)
...
```sh
helm repo update
helm upgrade dapr nholuongut/dapr --version 1.0.0-rc.2 --namespace dapr-system --reset-values --set-file dapr_sentry.tls.root.certPEM=./certs/ca.crt --set-file dapr_sentry.tls.issuer.certPEM=./certs/issuer.crt --set-file dapr_sentry.tls.issuer.keyPEM=./certs/issuer.key --set global.ha.enabled=true --wait
```

Due to Helm being unable to upgrade CRDs, we will need to upgrade CRD directly.
```sh
kubectl replace -f https://raw.githubusercontent.com/nholuongut/dapr/21636a9237f2dcecd9c80f329e99b512e8377739/charts/dapr/crds/configuration.yaml
kubectl replace -f https://raw.githubusercontent.com/nholuongut/dapr/21636a9237f2dcecd9c80f329e99b512e8377739/charts/dapr/crds/components.yaml
```
...
helm install dapr nholuongut/dapr --version 1.0.0-rc.2 --namespace dapr-system
```
