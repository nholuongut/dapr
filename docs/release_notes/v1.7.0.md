...
#### Additional component metrics
 - In order to provide increased visibility into operations, [new metrics have been added to components](https://github.com/nholuongut/dapr/blob/release-1.7/docs/development/dapr-metrics.md#dapr-component-metrics) including, pub/sub, bindings, state stores etc. For example, latencies when using a component or the number of times a given component has been called.
...
### Dapr Runtime
- **FIXED** Dapr setting a default content type of `text/plain` [4472](https://github.com/nholuongut/dapr/pull/4472)
- **ADDED** Circuit Breaking [777](https://github.com/nholuongut/dapr/issues/777)
- **ADDED** Content-Type for state operations [2892](https://github.com/nholuongut/dapr/issues/2892)
- **ADDED** Resiliency policies across all building blocks [3586](https://github.com/nholuongut/dapr/issues/3586)
- **CHANGED** Actor Reentrancy to stable feature [3811](https://github.com/nholuongut/dapr/issues/3811)
- **CHANGED** gRPC Proxying to stable feature [3814](https://github.com/nholuongut/dapr/issues/3814)
- **FIXED** Service invocation to return original status code on service invocation. Add the possibility to configure retries base on error type [3826](https://github.com/nholuongut/dapr/issues/3826)
- **FIXED** Serialization of 64bit values. [3837](https://github.com/nholuongut/dapr/issues/3837)
- **ADDED** Unsubscribe method for the configuration API. [3906](https://github.com/nholuongut/dapr/issues/3906)
- **FIXED** Bug in runtime matching wildcard routes for pubsub. [3920](https://github.com/nholuongut/dapr/issues/3920)
- **ADDED** Actor options configuration per actor type [3934](https://github.com/nholuongut/dapr/issues/3934)
- **ADDED** Logging for mTLS cert expiration [3940](https://github.com/nholuongut/dapr/issues/3940)
- **ADDED** Logging for sidecar pod name in Dapr Operator [3947](https://github.com/nholuongut/dapr/issues/3947)
- **FIXED** Method invocation / Dapr automatically decodes %2f in URL [4008](https://github.com/nholuongut/dapr/issues/4008)
- **FIXED** TLS connectivity to gRPC proxy functionality when --app-ssl is enabled [4048](https://github.com/nholuongut/dapr/issues/4048)
- **ADDED** More metrics [4068](https://github.com/nholuongut/dapr/issues/4068)
- **ADDED** logging for Dapr API calls over gRPC and HTTP [4119](https://github.com/nholuongut/dapr/issues/4119)
- **ADDED** Nightly builds for Dapr [4124](https://github.com/nholuongut/dapr/issues/4124)
- **FIXED** helm charts: increase failure threshold for liveness and readiness probes [4132](https://github.com/nholuongut/dapr/pull/4132)
- **ADDED** sidecar-injector health check port setting in helm chart [4174](https://github.com/nholuongut/dapr/issues/4174)
- **FIXED** Configuration API, listen to all keys [4178](https://github.com/nholuongut/dapr/issues/4178)
- **ADDED** HealthzPort option to injector helm chart - defaults to 8080 [4179](https://github.com/nholuongut/dapr/pull/4179)
- **FIXED** Dapr retries forever when app is erroring on subscriptions [4185](https://github.com/nholuongut/dapr/issues/4185)
- **FIXED** gRPC proxy connection closes after mTLS TTL passed [4197](https://github.com/nholuongut/dapr/issues/4197)
- **ADDED** Dapr images to GitHub container registry in addition to Docker Hub [4199](https://github.com/nholuongut/dapr/issues/4199)
- **FIXED** Multiple access control policies for a single app not working [4202](https://github.com/nholuongut/dapr/issues/4202)
- **ADDED** New options available for the default secret-reader deployed by the dapr_rbac subchart. [4203](https://github.com/nholuongut/dapr/issues/4203)
- **FIXED** Sidecar loads components instead of skipping if exists when operator stream reconnects [4212](https://github.com/nholuongut/dapr/issues/4212)
- **FIXED** Update of components in Kubernetes mode was accidentally available and not working properly, now blocked. [4218](https://github.com/nholuongut/dapr/issues/4218)
- **ADDED** Introduce state store component backed by Oracle Database or OCI Autonomous Database [4221](https://github.com/nholuongut/dapr/issues/4221)
- **FIXED** Condition in ReminderRename that would leave Reminder deleted. [4229](https://github.com/nholuongut/dapr/issues/4229)
- **CHANGED** Automatic State Store Encryption to stable feature [4260](https://github.com/nholuongut/dapr/issues/4260)
- **ADDED** `prometheus.io/probe` annotation [4272](https://github.com/nholuongut/dapr/issues/4272)
- **FIXED** When the deployment selector is updated, dapr will get a "connection refused" error [4287](https://github.com/nholuongut/dapr/issues/4287)
- **FIXED** Parity between HTTP and gRPC APIs when saving JSON state [4349](https://github.com/nholuongut/dapr/pull/4349)
- **FIXED** Concurrent map write error in placement [4353](https://github.com/nholuongut/dapr/issues/4353)
- **FIXED** Reduce placement blocking client [4361](https://github.com/nholuongut/dapr/pull/4361)
- **ADDED** Mirror of 3rd party container images to Dapr's GHCR [4365](https://github.com/nholuongut/dapr/pull/4365)
- **ADDED** Explicit support for other AES key sizes [4373](https://github.com/nholuongut/dapr/pull/4373)
- **FIXED** In Docker containers, use the CA cert bundle that's part of the base distroless images [4380](https://github.com/nholuongut/dapr/pull/4380)
- **ADDED** Resiliency: Debug logging when a circuit breaker changes state [4381](https://github.com/nholuongut/dapr/pull/4381)
- **ADDED** Rejson image to Dapr's GHCR [4411](https://github.com/nholuongut/dapr/pull/4411)
- **FIXED** Issue when actor reminders are used on single actor instance but is assigned on two pods on Kubernetes [4419](https://github.com/nholuongut/dapr/issues/4419)
- **ADDED** Support for Unix Domain Socket (UDS) on Kubernetes [4309](https://github.com/nholuongut/dapr/issues/4309)
- **FIXED** Allow disabling of default content-type for service invocation over HTTP where no content-type is specified [4469](https://github.com/nholuongut/dapr/issues/4469)
...
helm upgrade dapr nholuongut/dapr --version 1.7.0 --namespace=dapr-system --wait
```
...
helm install dapr nholuongut/dapr --version 1.7.0 --namespace dapr-system --wait
```
...
- This release include the breaking change to the MongoDB store [as described in v1.6.1 release notes](https://github.com/nholuongut/dapr/releases/tag/v1.6.1) to address a data serialization problem.
  - **FIXED** MongoDB state store: Removes MongoDB bson artifacts from JSON value output [1582](https://github.com/dapr/components-contrib/issues/1582)
