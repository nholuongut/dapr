...
* [Modified Dapr init and uninstall behavior](https://github.com/nholuongut/dapr/blob/release-0.9/docs/decision_records/cli/CLI-002-self-hosted-init-and-uninstall-behaviors.md)
