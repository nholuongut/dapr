...
2. Install the Dapr chart on your cluster in the dapr-system namespace:
    ```
    helm install dapr nholuongut/dapr --namespace dapr-system --create-namespace --wait
    ```
...
```
helm install dapr nholuongut/dapr --namespace dapr-system --create-namespace --set global.ha.enabled=true --wait
```
...
```
helm install dapr nholuongut/dapr --namespace dapr-system --create-namespace --set-string global.tag=edge --wait
```
...
Install dapr:
```bash
helm install dapr nholuongut/dapr --namespace dapr-system --create-namespace --values values.yml --wait
```
...
```bash
helm install dapr nholuongut/dapr --namespace dapr-system --create-namespace --set global.nodeSelector.myLabel=myValue --wait
```
